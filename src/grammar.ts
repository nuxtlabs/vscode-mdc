...
export const grammar: IRawGrammar = {
  ...
  repository: {
    block: {
      // 'Same as `text.html.markdown#block`, but without `raw_block`',
      patterns: [
        {
          include: '#component_block'
        },
  ...
  (?i:
    ...
    $
      ...
      patterns: [
        {
          //  'Highlight ending tag of inner components',
          match: '(^|\\G)\\s*([:]{2,})$',
          captures: {
            2: {
              name: 'punctuation.definition.tag.end.mdc'
  ...
  (
    ...
    'attribute-interior': {
      // 'https://github.com/microsoft/vscode/blob/08d59c432609ae9306eb3889815977e93bb548de/extensions/html/syntaxes/html.tmLanguage.json#L376',
      patterns: [
        {
          begin: '=',
          beginCaptures: {
    ...
    entities: {
      // 'https://github.com/microsoft/vscode/blob/08d59c432609ae9306eb3889815977e93bb548de/extensions/html/syntaxes/html.tmLanguage.json#L532',
      patterns: [
        {
          captures: {
            1: {
...
\t\t\t\t\t`,
  ...
  } as Partial<IRawRepository> as IRawRepository
}
